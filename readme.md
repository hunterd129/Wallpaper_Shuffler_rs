...
- In order to automate it, create a basic task with Windows Task Scheduler, tell it to run `Wallpaper_Shuffler.exe` in wherever you placed the binary, and set the interval to however often you want. E.G. hourly, daily, etc.
